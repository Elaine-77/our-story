  ...
  scenes: [
      ...
      hotspots: [
        {
          ...
          type: 'dialog',
          label: '电脑',
          bounds: { x: 8, y: 70, width: 14, height: 18 },
          dialogNodes: [
        ...
        },
        {
          ...
          type: 'dialog',
          label: '工牌',
          bounds: { x: 48, y: 68, width: 14, height: 15 },
          dialogNodes: [
        ...
        },
        {
          ...
          bounds: { x: 56, y: 82, width: 16, height: 12 },
          dialogNodes: [
    ...
    // --- Scene 1b: 欢送会 ---
    {
      ...
      hotspots: [
        {
          ...
          type: 'dialog',
          label: '蛋糕',
          bounds: { x: 15, y: 75, width: 20, height: 18 },
          dialogNodes: [
        ...
        },
        {
          ...
          type: 'dialog',
          label: '合照',
          bounds: { x: 35, y: 25, width: 30, height: 30 },
          dialogNodes: [
        ...
        },
        {
          ...
          type: 'dialog',
          label: '留言卡',
          bounds: { x: 5, y: 82, width: 12, height: 12 },
          dialogNodes: [
      ...
      dialog: [
        ...
        { type: 'bg-change-echo', echoId: 'chapter1:farewell', variants: {
          0: 'ch1-s2b-wave.jpg',
          1: 'ch1-s2b-lookback.jpg'
        }, default: 'ch1-s2b-wave.jpg' },
        { type: 'echo', echoId: 'chapter1:farewell', variants: {
          0: '他笑着朝大家挥了挥手，"下次聚餐别忘了我。"',
          1: '他抱着纸箱，在走廊尽头停下来，回头多看了一眼。'
        }, default: '他笑着朝大家挥了挥手。', speed: 50 },
      ...
      hotspots: [
        {
          ...
          type: 'dialog',
          label: '收费站',
          bounds: { x: 8, y: 25, width: 18, height: 20 },
          dialogNodes: [
        ...
        },
        {
          ...
          type: 'dialog',
          label: '加油站',
          bounds: { x: 70, y: 20, width: 20, height: 20 },
          dialogNodes: [
        ...
        },
        {
          ...
          bounds: { x: 35, y: 50, width: 18, height: 15 },
          dialogNodes: [
      ...
      hotspots: [
        {
          ...
          type: 'dialog',
          label: '建筑',
          bounds: { x: 20, y: 8, width: 60, height: 35 },
          dialogNodes: [
        ...
        },
        {
          ...
          type: 'dialog',
          label: '大门',
          bounds: { x: 32, y: 62, width: 15, height: 15 },
          dialogNodes: [
      ...
      hotspots: [
        {
          ...
          type: 'dialog',
          label: '马克杯',
          bounds: { x: 22, y: 60, width: 10, height: 15 },
          dialogNodes: [
        ...
        },
        {
          ...
          type: 'dialog',
          label: '照片',
          bounds: { x: 30, y: 52, width: 12, height: 18 },
          dialogNodes: [
        ...
        },
        {
          ...
          type: 'dialog',
          label: '收纳袋',
          bounds: { x: 43, y: 48, width: 22, height: 22 },
          dialogNodes: [
