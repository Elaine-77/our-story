  ...
  scenes: [
    ...
    // --- Scene 2: 展开信纸 ---
    {
      ...
      hotspots: [
        {
          ...
          bounds: { x: 30, y: 60, width: 40, height: 12 },
          dialogNodes: [
      ...
      dialog: [
        ...
        {
          type: 'echo',
          echoId: 'chapter2:bedtime-story',
          variants: {
            0: '"还记得小红和小黑吗？它们说，最好的礼物不是冒险，而是一起回家的路。"',
            1: '"还记得鼹鼠的故事吗？它说，最好的礼物不是宝藏，而是找到宝藏时身边的人。"',
            2: '"还记得波西和皮普吗？它们说，最好的礼物不是远方，而是每天醒来都能看到你。"'
          },
          default: '"还记得那些故事吗？它们说，最好的礼物不是远方，而是身边的人。"',
          speed: 45
        },
        { type: 'silence', duration: 2000 },
        { type: 'narrator', text: '"从那条一百公里的路开始，"', speed: 50 },
        { type: 'narrator', text: '"到小雏菊田里转圈的那个下午，"', speed: 50 },
        { type: 'narrator', text: '"每一页，都是你写的。"', speed: 55 },
    ...
    // --- Scene 3: 信纸最后一行 ---
    {
      ...
      dialog: [
        ...
        { type: 'silence', duration: 2000 },
        { type: 'narrator', text: '"回头看看。"', speed: 80 },
        { type: 'silence', duration: 2500 }
      ]
    },
      ...
      hotspots: [
        {
          ...
          type: 'dialog',
          label: '蜡烛',
          bounds: { x: 35, y: 30, width: 30, height: 25 },
          dialogNodes: [
